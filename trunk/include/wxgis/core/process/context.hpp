...
public:
    ...
    basic_work_directory_context()
    {
        ...
        if (size == -1 && errno)
            boost::throw_exception(std::runtime_error("boost::process::basic_work_directory_context::basic_work_directory_context: pathconf(2) failed"));
        ...
        if (!::getcwd(cwd.get(), size))
            boost::throw_exception(std::runtime_error("boost::process::basic_work_directory_context::basic_work_directory_context: getcwd(2) failed"));
        ...
        if (!::GetCurrentDirectoryA(sizeof(cwd), cwd))
            boost::throw_exception(std::runtime_error("boost::process::basic_work_directory_context::basic_work_directory_context: GetCurrentDirectory failed"));
            //boost::throw_exception(std::runtime_error("boost::process::basic_work_directory_context::basic_work_directory_context: GetCurrentDirectory failed"));
        work_directory = cwd;
#endif
