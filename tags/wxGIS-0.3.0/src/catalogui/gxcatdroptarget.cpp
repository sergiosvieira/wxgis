...
// ----------------------------------------------------------------------------
// wxGISCatalogDropTarget
// ----------------------------------------------------------------------------

wxGISCatalogDropTarget::wxGISCatalogDropTarget(IGxViewDropTarget *pOwner)
{
    m_pOwner = pOwner;
    //wxDF_FILENAME 
    //m_dataObject;
...
wxGISCatalogDropTarget::~wxGISCatalogDropTarget(void)
{
}

wxDragResult wxGISCatalogDropTarget::OnDragOver(wxCoord x, wxCoord y, wxDragResult def)
{
    return m_pOwner->OnDragOver(x, y, def);
}

wxDragResult wxGISCatalogDropTarget::OnEnter(wxCoord x, wxCoord y, wxDragResult def)
{
    return def;
}

void wxGISCatalogDropTarget::OnLeave()
{
    m_pOwner->OnLeave();
}

bool wxGISCatalogDropTarget::OnDropFiles(wxCoord x, wxCoord y, const wxArrayString& filenames)
{
